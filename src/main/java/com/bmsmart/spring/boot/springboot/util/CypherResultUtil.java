...
import com.bmsmart.spring.boot.springboot.model.neo4j.Relationship;
import com.bmsmart.spring.boot.springboot.model.neo4j.ResultData;
import com.bmsmart.spring.boot.springboot.myenum.LabelType;
...
public class CypherResultUtil {
    ...
    public static ResultData dealwithResult(List<Record> greeting) {
        ArrayList<com.bmsmart.spring.boot.springboot.model.neo4j.Node> nodes = new ArrayList<>();
            ...
            if (keys.size() > 0) {
                ...
                for (String key : keys) {
                    ...
                    if ("NODE".equals(value_type)) {
                        ...
                        long id = node.id();
                        com.bmsmart.spring.boot.springboot.model.neo4j.Node node1 = new com.bmsmart.spring.boot.springboot.model.neo4j.Node();
                        //判断节点标签类型
